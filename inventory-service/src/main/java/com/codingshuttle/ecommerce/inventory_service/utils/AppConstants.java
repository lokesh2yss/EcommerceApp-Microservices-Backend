package com.codingshuttle.ecommerce.inventory_service.utils;

public class AppConstants {
    public static final String ORDER_CREATED_TOPIC = "order-created-topic";
    public static final String ORDER_STATUS_UPDATED_TOPIC = "order-status-updated-topic";
    ...
    public static final String ORDER_SHIPPED_TOPIC = "order-shipped-topic";
